classdef VariableMeanCenterSurroundNoise < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    methods
        ...
        function prepareEpoch(obj, epoch)
            ...
            epoch.addParameter('centerMean', obj.centerMean);
            epoch.addParameter('surroundMean', obj.surroundMean);
        ...
        function p = createPresentation(obj)
            ...
            centerSpot.color=obj.centerMean;
            ...
            function i = getCenterIntensity(obj, frame)
                ...
                if frame<0 %pre frames. frame 0 starts stimPts
                    intensity = obj.centerMean;
                else %in stim frames
                    if mod(frame, obj.frameDwell) == 0 %noise update
                        intensity = obj.centerMean + ...
                            obj.noiseStdv * obj.centerMean * obj.centerNoiseStream.randn;
                    end
                end
                i = intensity;
