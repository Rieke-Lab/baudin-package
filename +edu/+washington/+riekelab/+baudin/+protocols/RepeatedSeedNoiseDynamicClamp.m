classdef RepeatedSeedNoiseDynamicClamp < edu.washington.riekelab.protocols.RiekeLabProtocol
    properties
        gExcMultiplier = 1
        gInhMultiplier = 1
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            obj.numEpochs = size(obj.conductanceData.conductances, 1);
        ...
        function conductance = determineConductance(obj, epochNum)
