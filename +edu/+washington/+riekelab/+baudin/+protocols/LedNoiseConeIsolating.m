classdef LedNoiseConeIsolating < edu.washington.riekelab.protocols.RiekeLabProtocol
    ...
    properties
        ...
        coneTypeToStimulate             % Cone type at which the stimulus will be directed
        meanIsomerizations = 1000       % Noise and background mean in units of isomerizations
        standardDeviation = 500         % Noise standard deviation in units of isomerizations   
        numberOfAverages = uint16(5)    % Number of times to repeat each standard deviation multiple
    ...
    properties (Hidden)
        coneType = symphonyui.core.PropertyType('char', 'row', {'s cone', 'm cone', 'l cone'})
        ampType
    end
