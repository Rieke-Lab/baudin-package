classdef ConeSpecificAdaptationSinusoidsContrast < edu.washington.riekelab.protocols.RiekeLabProtocol
    ...
    properties
        ...
        coneOnConstantToStimulate = ...
            edu.washington.riekelab.baudin.protocols.ConeSpecificAdaptationSinusoids.CONE_TYPES_LMS
    ...
    properties (Constant)
        ...
        M_CONE = 'm cone';
        L_CONE = 'l cone';
        CONE_TYPES_LMS_LMS = {edu.washington.riekelab.baudin.protocols.ConeSpecificAdaptationSinusoids.L_CONE, ...
            edu.washington.riekelab.baudin.protocols.ConeSpecificAdaptationSinusoids.M_CONE, ...
            edu.washington.riekelab.baudin.protocols.ConeSpecificAdaptationSinusoids.S_CONE};
    end
    ...
    methods
        ...
        function value = get.lmsMeanIsomerizations(obj)
            value = [obj.lConeMean; obj.mConeMean; obj.sConeMean];
        end
        ...
        function [lmsMeans, lmsContrasts, coneWithStimulus] = GetLmsMeanIsomerizations(obj, epochNumber)
            ...
            lmsTypes = edu.washington.riekelab.baudin.protocols.ConeSpecificAdaptationSinusoids.CONE_TYPES_LMS;
            lmsMeans = ...
            ...
            lmsContrasts = obj.sinusoidContrast * obj.lmsMeans .* cellfun(isCorrectConeType, lmsTypes)';
        ...
        function prepareEpoch(obj, epoch)
            ...
            lmsMeans = obj.GetLmsMeanIsomerizations(epochNumber);
            lmsContrasts = obj.sinusoidContrast * obj.constantConeBackground * cellfun( ...
                @(x) strcmp(x, obj.coneOnConstantToStimulate), ...
                edu.washington.riekelab.baudin.ConeSpecificAdaptationSinuosids.CONE_TYPES_LMS)';
