classdef VariableMeanNoise < edu.washington.riekelab.protocols.RiekeLabProtocol
    ...
    methods
        ...
        function [stim, stdv] = createLedStimulus(obj, seed)
            if numel(obj.lightMean)>2
                cMean = obj.lightMean(randi([1 length(obj.lightMean)]));
            else  
                cMean = obj.lightMean(2-mod(obj.numEpochsPrepared,2));
            end
            lightContrast = obj.Contrast(randi([1 length(obj.Contrast)]));
            stdv = cMean * lightContrast;
        ...
        function prepareEpoch(obj, epoch)
            ...
            [stim, stdv] = obj.createLedStimulus(seed);
