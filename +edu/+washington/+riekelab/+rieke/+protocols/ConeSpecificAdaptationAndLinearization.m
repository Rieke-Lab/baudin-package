classdef ConeSpecificAdaptationAndLinearization <edu.washington.riekelab.protocols.RiekeLabProtocol
    properties
        ...
        coneOnChangingBackgroundToStim=edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationModulatedLuminanceSteps.M_CONE;
    ...
    properties(Hidden)
        coneOnConstantToStimulateType = symphonyui.core.PropertyType( ...
            'char', 'row', edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationSinusoidsContrast.CONE_TYPES_LMS)
    ...
    properties (Constant)
        ...
        M_CONE = 'm cone';
        L_CONE = 'l cone';
        CONE_TYPES_LMS = {edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationSinusoidsContrast.L_CONE, ...
            edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationSinusoidsContrast.M_CONE, ...
            edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationSinusoidsContrast.S_CONE};
    end
    ...
    methods
        ...
        function value = get.redLed(obj)
            value = obj.rig.getDevice(edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationSinusoidsContrast.RED_LED);
        end
        
        function value = get.blueLed(obj)
            value = obj.rig.getDevice(edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationSinusoidsContrast.BLUE_LED);
        end
        
        function value = get.uvLed(obj)
            value = obj.rig.getDevice(edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationSinusoidsContrast.UV_LED);
        end
        ...
        function [lmsWaves,coneWithStimulus] = getLmsWaves(obj, index)
            ...
            lmsTypes = edu.washington.riekelab.rieke.protocols.ConeSpecificAdaptationSinusoidsContrast.CONE_TYPES_LMS;
