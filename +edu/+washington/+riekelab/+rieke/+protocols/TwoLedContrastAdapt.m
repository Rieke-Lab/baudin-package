classdef TwoLedContrastAdapt < edu.washington.riekelab.protocols.RiekeLabProtocol
    ...
    properties
        led1                            % Output LED 1
        led2                            % Output LED 2
        preTime = 100                   % Noise leading duration led 1(ms)
        stimTime = 5000                  % Noise duration (ms)
        tailTime = 100                  % Noise trailing duration (ms)
        frequencyCutoff1 = 20           % Noise frequency cutoff for smoothing, LED 1 (Hz)
        frequencyCutoff2 = 20           % Noise frequency cutoff for smoothing, LED 2 (Hz)
        ...
        stdv1 = 0.05                   % Noise standard deviation, post-smoothing, LED 1 (V or norm. [0-1] depending on LED units)
        stdv2 = 0.05                   % Noise standard deviation, post-smoothing, LED 2 (V or norm. [0-1] depending on LED units)
    ...
    methods
        ...
        function stim = createLedStimulus(obj, ledNum, seed)
            ...
            if ledNum == 1
                ...
                gen.tailTime = obj.tailTime + obj.stimTime;
            elseif ledNum == 2
                gen.stDev = obj.stdv2;
                ...
                gen.preTime = obj.preTime + obj.stimTime;
